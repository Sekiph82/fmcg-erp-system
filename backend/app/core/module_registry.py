...
ENDPOINT_ROUTE_DEFINITIONS: tuple[EndpointRouteDefinition, ...] = (
    ...
    EndpointRouteDefinition(key="recipes", route_prefix="/recipes", import_path="app.api.v1.endpoints.recipes", tags=('recipes',)),
    ...
    EndpointRouteDefinition(key="hr", route_prefix="/hr", import_path="app.api.v1.endpoints.hr", tags=('hr',)),
    EndpointRouteDefinition(key="documents", route_prefix="/documents", import_path="app.api.v1.endpoints.documents", tags=('documents',)),
    ...
    EndpointRouteDefinition(key="payroll_ke", route_prefix="/payroll-ke", import_path="app.api.v1.endpoints.payroll_ke", tags=('payroll-ke',)),
    ...
    EndpointRouteDefinition(key="esign", route_prefix="/esign", import_path="app.api.v1.endpoints.esign", tags=('esign',)),
    EndpointRouteDefinition(key="bank_api", route_prefix="/bank-api", import_path="app.api.v1.endpoints.bank_api", tags=('bank-api',)),
    EndpointRouteDefinition(key="knowledge_base", route_prefix="/kb", import_path="app.api.v1.endpoints.knowledge_base", tags=('knowledge-base',)),
    ...
    EndpointRouteDefinition(key="npd_workflow", route_prefix="/npd-workflow", import_path="app.api.v1.endpoints.npd_workflow", tags=('npd-workflow',)),
    EndpointRouteDefinition(key="consumer_complaints", route_prefix="/consumer-complaints", import_path="app.api.v1.endpoints.consumer_complaints", tags=('consumer-complaints',)),
