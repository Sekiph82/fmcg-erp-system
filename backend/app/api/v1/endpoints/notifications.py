...
@router.post("/preferences/{user_id}/seed-defaults",
             dependencies=[Depends(require_permission("notifications", "configure"))])
...
@router.post("/schedules/process-due",
             dependencies=[Depends(require_permission("notifications", "admin"))])
...
@router.get("/reports/delivery",
            dependencies=[Depends(require_permission("notifications", "report"))])
