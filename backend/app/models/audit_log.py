...
class AuditEvent:
    ...
    ROLE_SCOPE_ASSIGNED = "ROLE_SCOPE_ASSIGNED"
    ROLE_SCOPE_REMOVED = "ROLE_SCOPE_REMOVED"
    USER_SCOPE_ASSIGNED = "USER_SCOPE_ASSIGNED"
    USER_SCOPE_REMOVED = "USER_SCOPE_REMOVED"
