/**
 * FMCG ERP Logistics Module Manual — PDF Generator
 *
 * Run from repo root:
 *   node docs/user-manual/module-manuals/logistics/pdf-export/generate-logistics-pdf.mjs
 */
...
const MANUAL_DIR      = path.join(REPO_ROOT, "docs", "user-manual", "module-manuals", "logistics");
...
const OUTPUT_FILE     = path.join(OUTPUT_DIR, "FMCG-ERP-Logistics-Manual.pdf");

const CHAPTERS = [
  "00-overview.md",
  "01-shipments.md",
  "02-containers.md",
  "03-arrivals-clearance.md",
  "04-documents.md",
  "05-fleet.md",
];

const REQUIRED_SCREENSHOTS = [
  "module-ui/logistics/overview/overview-tab.png",
  "module-ui/logistics/shipments/shipments-tab.png",
  "module-ui/logistics/shipments/new-shipment-modal.png",
  "module-ui/logistics/containers/containers-tab.png",
  "module-ui/logistics/arrivals/arrivals-tab.png",
  "module-ui/logistics/documents/documents-tab.png",
  "module-ui/logistics/fleet/fleet-tab.png",
];
...
<div class="cover-page">
  <div class="cover-content">
    ...
    <h2 class="cover-subtitle">Logistics Module Manual</h2>
    <div class="cover-meta">
      <p><strong>Version:</strong> 1.0</p>
      <p><strong>Date:</strong> ${dateStr}</p>
      <p><strong>Scope:</strong> International Shipments · Containers · Customs · Fleet</p>
...
h1{font-size:18pt;font-weight:700;color:#164e63;margin-top:24pt;border-bottom:2px solid #164e63;padding-bottom:4pt}
h2{font-size:14pt;font-weight:600;color:#0e7490;margin-top:18pt}
h3{font-size:12pt;font-weight:600;color:#155e75;margin-top:14pt}
table{border-collapse:collapse;width:100%;margin:12pt 0;font-size:9.5pt}
th{background:#cffafe;font-weight:600;text-align:left;padding:6pt 8pt;border:1px solid #67e8f9}
td{padding:5pt 8pt;border:1px solid #e2e8f0;vertical-align:top}
tr:nth-child(even){background:#f0fdff}
code{font-family:'Courier New',monospace;font-size:9pt;background:#f0fdff;padding:1pt 3pt;border-radius:2pt}
pre{background:#f0fdff;padding:10pt;border-radius:4pt;font-size:9pt;white-space:pre-wrap}
blockquote{border-left:4px solid #67e8f9;margin:8pt 0;padding:4pt 12pt;background:#f0fdff;color:#4a5568}
img{max-width:100%;border:1px solid #e2e8f0;border-radius:4pt;margin:8pt 0}
.cover-page{display:flex;align-items:center;justify-content:center;min-height:100vh;background:linear-gradient(135deg,#164e63 0%,#0891b2 100%);color:white;text-align:center}
...
@page{margin:20mm 18mm}`;
  ...
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>FMCG ERP Logistics Module Manual</title><style>${css}</style></head><body>${cover}${parts.join("\n")}</body></html>`;
}
...
async function generatePdf() {
  ...
  const tmp = path.join(OUTPUT_DIR, "_temp_logistics_manual.html");
  ...
  await page.pdf({
    ...
    headerTemplate: `<div style="font-size:8pt;color:#999;width:100%;text-align:center;padding-top:4mm;">FMCG ERP — Logistics Module Manual — Confidential</div>`,
