/**
 * FMCG ERP Sales & Distribution Module Manual — PDF Generator
 *
 * Uses Playwright Chromium (frontend/node_modules) + marked to produce:
 *   docs/user-manual/pdf-output/FMCG-ERP-Sales-Distribution-Manual.pdf
 *
 * Run from repo root:
 *   node docs/user-manual/module-manuals/sales/pdf-export/generate-sales-pdf.mjs
 *
 * Requirements:
 *   - Node.js 18+
 ...
 *   - Shared screenshots at docs/user-manual/screenshots/captured/ (optional)
 */
...
const MANUAL_DIR      = path.join(REPO_ROOT, "docs", "user-manual", "module-manuals", "sales");
const SCREENSHOTS_DIR = path.join(REPO_ROOT, "docs", "user-manual", "screenshots", "captured");
const CSS_FILE        = path.join(__dirname, "sales-style.css");
const OUTPUT_DIR      = path.join(REPO_ROOT, "docs", "user-manual", "pdf-output");
const OUTPUT_FILE     = path.join(OUTPUT_DIR, "FMCG-ERP-Sales-Distribution-Manual.pdf");

// ── Chapter order ──────────────────────────────────────────────────────────

const CHAPTERS = [
  "00-overview.md",
  "01-sales-overview.md",
  "02-orders.md",
  "03-customers-invoices.md",
  "04-quotes-shipments.md",
  "05-collections-returns.md",
  "06-pricing.md",
  "07-distribution.md",
  "08-commissions-recurring-portal.md",
];

// ── Required screenshots ───────────────────────────────────────────────────

const REQUIRED_SCREENSHOTS = [
  "module-ui/sales/sales/overview-tab.png",
  "module-ui/sales/sales/orders-tab.png",
  "module-ui/sales/sales/invoices-tab.png",
  "module-ui/sales/sales/customers-tab.png",
  "module-ui/sales/sales/quotes-tab.png",
  "module-ui/sales/sales/shipments-tab.png",
  "module-ui/sales/sales/delivery-tab.png",
  "module-ui/sales/sales/collections-tab.png",
  "module-ui/sales/sales/returns-tab.png",
  "module-ui/sales/sales/pricing-tab.png",
  "module-ui/sales/sales/price-lists-tab.png",
  "module-ui/sales/sales/dynamic-pricing-tab.png",
  "module-ui/sales/sales/contracts-tab.png",
  "module-ui/sales/sales/recurring-tab.png",
  "module-ui/sales/sales/commissions-tab.png",
  "module-ui/sales/sales/secondary-tab.png",
  "module-ui/sales/sales/van-sales-tab.png",
  "module-ui/sales/sales/distributors-tab.png",
  "module-ui/sales/sales/field-sales-tab.png",
  "module-ui/sales/sales/margin-tab.png",
  "module-ui/sales/sales/portal-tab.png",
  "module-ui/sales/sales/reports-tab.png",
  "module-ui/sales/orders/new-order-modal.png",
  "module-ui/sales/orders/order-dropdowns.png",
  "module-ui/sales/customers/new-customer-modal.png",
  "module-ui/sales/customers/customer-dropdowns.png",
  "module-ui/sales/pricing/new-pricing-rule-modal.png",
];
...
<div class="cover-page">
  <div class="cover-content">
    ...
    <h2 class="cover-subtitle">Sales &amp; Distribution Module Manual</h2>
    <div class="cover-meta">
      <p><strong>Version:</strong> 1.0</p>
      <p><strong>Date:</strong> ${dateStr}</p>
      <p><strong>Scope:</strong> Orders · Invoices · Customers · Pricing · Shipments · Van Sales · Distributors · Field Sales</p>
...
<title>FMCG ERP Sales &amp; Distribution Module Manual</title>
<style>
${css}
</style>
</head>
...
h1 { font-size: 18pt; font-weight: 700; color: #1a3a5c; margin-top: 24pt; border-bottom: 2px solid #1a3a5c; padding-bottom: 4pt; }
h2 { font-size: 14pt; font-weight: 600; color: #1e6091; margin-top: 18pt; }
...
th { background: #d1e9f6; font-weight: 600; text-align: left; padding: 6pt 8pt; border: 1px solid #7ec8e3; }
...
.cover-page { display: flex; align-items: center; justify-content: center; min-height: 100vh; background: linear-gradient(135deg, #1a3a5c 0%, #1e6091 100%); color: white; text-align: center; }
...
async function generatePdf() {
  ...
  const tmpHtml = path.join(OUTPUT_DIR, "_temp_sales_manual.html");
  ...
  await page.pdf({
    ...
    headerTemplate: `<div style="font-size:8pt;color:#999;width:100%;text-align:center;padding-top:4mm;">FMCG ERP — Sales &amp; Distribution Module Manual — Confidential</div>`,
