/**
 * FMCG ERP CRM Module Manual — PDF Generator
 *
 * Uses Playwright Chromium (frontend/node_modules) + marked to produce:
 *   docs/user-manual/pdf-output/FMCG-ERP-CRM-Manual.pdf
 *
 * Run from repo root:
 *   node docs/user-manual/module-manuals/crm/pdf-export/generate-crm-pdf.mjs
 *
 * Requirements:
 *   - Node.js 18+
...
const MANUAL_DIR      = path.join(REPO_ROOT, "docs", "user-manual", "module-manuals", "crm");
...
const OUTPUT_FILE     = path.join(OUTPUT_DIR, "FMCG-ERP-CRM-Manual.pdf");
...
<div class="cover-page">
  <div class="cover-content">
    ...
    <h2 class="cover-subtitle">CRM Module Manual</h2>
    <div class="cover-meta">
      <p><strong>Version:</strong> 1.0</p>
      <p><strong>Date:</strong> ${dateStr}</p>
      <p><strong>Scope:</strong> Pipeline · Leads · Opportunities · Activities · Forecast · Territory · Stages · Win/Loss · Loyalty · NPS · Surveys</p>
...
.cover-page { display: flex; align-items: center; justify-content: center; min-height: 100vh; background: linear-gradient(135deg, #1e3a5f 0%, #2563eb 100%); color: white; text-align: center; }
...
<title>FMCG ERP CRM Module Manual</title>
<style>
${css}
</style>
</head>
...
async function generatePdf() {
  ...
  const tmpHtml = path.join(OUTPUT_DIR, "_temp_crm_manual.html");
  ...
  await page.pdf({
    ...
    headerTemplate: `<div style="font-size:8pt;color:#999;width:100%;text-align:center;padding-top:4mm;">FMCG ERP — CRM Module Manual — Confidential</div>`,
