/**
 * FMCG ERP HR & People Management Module Manual — PDF Generator
 *
 * Uses Playwright Chromium (frontend/node_modules) + marked to produce:
 *   docs/user-manual/pdf-output/FMCG-ERP-HR-Manual.pdf
 *
 * Run from repo root:
 *   node docs/user-manual/module-manuals/hr/pdf-export/generate-hr-pdf.mjs
 *
 * Requirements:
 *   - Node.js 18+
...
const MANUAL_DIR      = path.join(REPO_ROOT, "docs", "user-manual", "module-manuals", "hr");
...
const OUTPUT_FILE     = path.join(OUTPUT_DIR, "FMCG-ERP-HR-Manual.pdf");
...
const CHAPTERS = [
  ...
  "05-payroll.md",
  "06-shifts.md",
  "07-recruitment-ess.md",
  "08-appraisals-training.md",
  "09-timesheets-expenses.md",
];

// ── Required screenshots ───────────────────────────────────────────────────

const REQUIRED_SCREENSHOTS = [
  "module-ui/hr/hr/overview-tab.png",
  "module-ui/hr/hr/employees-tab.png",
  "module-ui/hr/hr/attendance-tab.png",
  "module-ui/hr/hr/leave-tab.png",
  "module-ui/hr/hr/payroll-tab.png",
  "module-ui/hr/hr/shifts-tab.png",
  "module-ui/hr/hr/recruitment-tab.png",
  "module-ui/hr/hr/ess-tab.png",
  "module-ui/hr/hr/appraisals-tab.png",
  "module-ui/hr/hr/training-tab.png",
  "module-ui/hr/hr/timesheets-tab.png",
  "module-ui/hr/hr/expenses-tab.png",
  "module-ui/hr/employees/new-employee-form.png",
  "module-ui/hr/employees/employee-dropdowns.png",
  "module-ui/hr/attendance/record-attendance-form.png",
  "module-ui/hr/attendance/attendance-dropdowns.png",
  "module-ui/hr/leave/new-leave-form.png",
  "module-ui/hr/leave/leave-type-dropdown.png",
  "module-ui/hr/payroll/new-period-form.png",
  "module-ui/hr/payroll/payroll-month-dropdown.png",
  "module-ui/hr/shifts/new-template-form.png",
  "module-ui/hr/shifts/assign-shift-form.png",
];
...
<div class="cover-page">
  <div class="cover-content">
    ...
    <h2 class="cover-subtitle">HR &amp; People Management Module Manual</h2>
    <div class="cover-meta">
      <p><strong>Version:</strong> 1.0</p>
      <p><strong>Date:</strong> ${dateStr}</p>
      <p><strong>Scope:</strong> Employees · Attendance · Leave · Payroll · Shifts · Recruitment · ESS · Appraisals · Training · Timesheets · Expenses</p>
...
h1 { font-size: 18pt; font-weight: 700; color: #2d4739; margin-top: 24pt; border-bottom: 2px solid #2d4739; padding-bottom: 4pt; }
h2 { font-size: 14pt; font-weight: 600; color: #3a7d44; margin-top: 18pt; }
...
th { background: #c8e6c9; font-weight: 600; text-align: left; padding: 6pt 8pt; border: 1px solid #81c784; }
...
blockquote { border-left: 4px solid #81c784; margin: 8pt 0; padding: 4pt 12pt; background: #f9fdf9; color: #4a5568; }
img { max-width: 100%; border: 1px solid #e2e8f0; border-radius: 4pt; margin: 8pt 0; }
.cover-page { display: flex; align-items: center; justify-content: center; min-height: 100vh; background: linear-gradient(135deg, #1b5e20 0%, #388e3c 100%); color: white; text-align: center; }
...
<title>FMCG ERP HR &amp; People Management Module Manual</title>
<style>
${css}
</style>
</head>
...
async function generatePdf() {
  ...
  const tmpHtml = path.join(OUTPUT_DIR, "_temp_hr_manual.html");
  ...
  await page.pdf({
    ...
    headerTemplate: `<div style="font-size:8pt;color:#999;width:100%;text-align:center;padding-top:4mm;">FMCG ERP — HR &amp; People Management Module Manual — Confidential</div>`,
