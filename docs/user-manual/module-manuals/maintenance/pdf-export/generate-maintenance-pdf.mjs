/**
 * FMCG ERP Maintenance Module Manual — PDF Generator
 *
 * Run from repo root:
 *   node docs/user-manual/module-manuals/maintenance/pdf-export/generate-maintenance-pdf.mjs
 */
...
const MANUAL_DIR      = path.join(REPO_ROOT, "docs", "user-manual", "module-manuals", "maintenance");
...
const OUTPUT_FILE     = path.join(OUTPUT_DIR, "FMCG-ERP-Maintenance-Manual.pdf");
...
const REQUIRED_SCREENSHOTS = [
  "module-ui/maintenance/overview/overview-tab.png",
  "module-ui/maintenance/assets/assets-tab.png",
  "module-ui/maintenance/assets/new-asset-modal.png",
  "module-ui/maintenance/breakdowns/breakdowns-tab.png",
  "module-ui/maintenance/breakdowns/log-breakdown-modal.png",
  "module-ui/maintenance/plans/plans-tab.png",
  "module-ui/maintenance/plans/work-orders-tab.png",
  "module-ui/maintenance/plans/new-plan-modal.png",
  "module-ui/maintenance/predictive/predictive-tab.png",
  "module-ui/maintenance/spares/spares-tab.png",
  "module-ui/maintenance/spares/add-part-modal.png",
  "module-ui/maintenance/reports/reports-tab.png",
];
...
<div class="cover-page">
  <div class="cover-content">
    ...
    <h2 class="cover-subtitle">Maintenance Module Manual</h2>
    <div class="cover-meta">
      <p><strong>Version:</strong> 1.0</p>
      <p><strong>Date:</strong> ${dateStr}</p>
      <p><strong>Scope:</strong> Assets · Breakdowns · PM Plans · Predictive · Spares · Reports</p>
...
h1{font-size:18pt;font-weight:700;color:#78350f;margin-top:24pt;border-bottom:2px solid #78350f;padding-bottom:4pt}
h2{font-size:14pt;font-weight:600;color:#92400e;margin-top:18pt}
h3{font-size:12pt;font-weight:600;color:#b45309;margin-top:14pt}
table{border-collapse:collapse;width:100%;margin:12pt 0;font-size:9.5pt}
th{background:#fef3c7;font-weight:600;text-align:left;padding:6pt 8pt;border:1px solid #fcd34d}
td{padding:5pt 8pt;border:1px solid #e2e8f0;vertical-align:top}
tr:nth-child(even){background:#fffbeb}
code{font-family:'Courier New',monospace;font-size:9pt;background:#fffbeb;padding:1pt 3pt;border-radius:2pt}
pre{background:#fffbeb;padding:10pt;border-radius:4pt;font-size:9pt;white-space:pre-wrap}
blockquote{border-left:4px solid #fcd34d;margin:8pt 0;padding:4pt 12pt;background:#fffbeb;color:#4a5568}
img{max-width:100%;border:1px solid #e2e8f0;border-radius:4pt;margin:8pt 0}
.cover-page{display:flex;align-items:center;justify-content:center;min-height:100vh;background:linear-gradient(135deg,#78350f 0%,#d97706 100%);color:white;text-align:center}
...
@page{margin:20mm 18mm}`;
  ...
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>FMCG ERP Maintenance Module Manual</title><style>${css}</style></head><body>${cover}${parts.join("\n")}</body></html>`;
}
...
async function generatePdf() {
  ...
  const tmp = path.join(OUTPUT_DIR, "_temp_maintenance_manual.html");
  ...
  await page.pdf({
    ...
    headerTemplate: `<div style="font-size:8pt;color:#999;width:100%;text-align:center;padding-top:4mm;">FMCG ERP — Maintenance Module Manual — Confidential</div>`,
