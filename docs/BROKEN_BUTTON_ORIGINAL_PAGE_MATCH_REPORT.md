...
| Working targets | 357 |
| **Total broken visible action targets** | **102** |
| Critical severity (create/run/approve actions) | 0 |
| High severity | 48 |
| Medium severity | 54 |
| Git history matches found | 55 |
| **High-confidence: real page existed in git** | **54** |
...
Their internal navigation cards/buttons (totalling **102**) all fail silently
...
| BVT-0005 | Other | /dashboard/ai?tab=AICompliancePage | Quality Module | `/dashboard/production/quality` | no_route_file | none | CREATE_NEW_REAL_PAGE_REQUIRED |
| BVT-0018 | Commercial / CRM | /dashboard/crm?tab=CRMPipelinePage | ${rec.id | `/dashboard/crm/records/${rec.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0019 | Commercial / CRM | /dashboard/crm?tab=CRMLeadsPage | View | `/dashboard/crm/records/${rec.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0020 | Commercial / CRM | /dashboard/crm?tab=CRMOppsPage | View | `/dashboard/crm/records/${rec.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0021 | Commercial / CRM | /dashboard/crm?tab=CRMActivitiesPage | ${act.crm_record_id | `/dashboard/crm/records/${act.crm_record_id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0022 | Commercial / CRM | /dashboard/crm?tab=NPSPage | surveys | `/dashboard/nps/surveys` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0023 | Commercial / CRM | /dashboard/crm?tab=SurveysPage | ${s.id | `/dashboard/surveys/${s.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0024 | Documents & Communication | /dashboard/documents?tab=DocsCompliancePage | ${d.id | `/dashboard/documents/${d.id` | no_route_file | none | CREATE_NEW_REAL_PAGE_REQUIRED |
| BVT-0025 | Documents & Communication | /dashboard/documents?tab=DocsExpiringPage | ${d.id | `/dashboard/documents/${d.id` | no_route_file | none | CREATE_NEW_REAL_PAGE_REQUIRED |
| BVT-0026 | Documents & Communication | /dashboard/documents?tab=KnowledgeBasePage | ${a.id | `/dashboard/knowledge-base/${a.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0027 | Documents & Communication | /dashboard/documents?tab=KnowledgeBasePage | Categories | `/dashboard/knowledge-base/categories` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0028 | Finance | /dashboard/finance?tab=FinanceAccountingPage | Purchase Invoices | `/dashboard/finance/accounting/controls` | middleware_redirect | stub | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0030 | Finance | /dashboard/finance?tab=BankReconPage | ${s.id | `/dashboard/bank-reconciliation/statements/${s.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0032 | Finance | /dashboard/finance?tab=InvoiceMatchPage | View | `/dashboard/invoice-match/${m.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0035 | Finance | /dashboard/finance?tab=DunningPage | ${c.id | `/dashboard/dunning/cases/${c.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0049 | Supply Chain / Inventory | /dashboard/inventory?tab=TraceabilityPage | ${r.id | `/dashboard/traceability/recalls/${r.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
| BVT-0051 | Commercial / Marketing | /dashboard/marketing?tab=MarketingCampaignsPage | ${c.id | `/dashboard/marketing/campaigns/${c.id` | middleware_redirect | none | CONVERT_TO_WORKSPACE_SUBVIEW |
...
| `custom-fields/page.tsx` | `/dashboard/custom-fields` | `/dashboard/admin?tab=custom-fields` | `/dashboard/admin` | 2 |
...
| `report-builder/page.tsx` | `/dashboard/report-builder` | `/dashboard/analytics?tab=report-builder` | `/dashboard/analytics` | 1 |
| `chatter/page.tsx` | `/dashboard/chatter` | `/dashboard/communication?tab=chatter` | `/dashboard/communication` | 2 |
...
| `notification-center/page.tsx` | `/dashboard/notification-center` | `/dashboard/communication?tab=notifications` | `/dashboard/communication` | 2 |
...
| `bank-reconciliation/page.tsx` | `/dashboard/bank-reconciliation` | `/dashboard/finance?tab=bank-recon` | `/dashboard/finance` | 2 |
| `invoice-match/page.tsx` | `/dashboard/invoice-match` | `/dashboard/finance?tab=invoice-match` | `/dashboard/finance` | 2 |
| `fixed-assets/page.tsx` | `/dashboard/fixed-assets` | `/dashboard/finance?tab=fixed-assets` | `/dashboard/finance` | 1 |
| `dimensions/page.tsx` | `/dashboard/dimensions` | `/dashboard/finance?tab=dimensions` | `/dashboard/finance` | 1 |
| `dunning/page.tsx` | `/dashboard/dunning` | `/dashboard/finance?tab=dunning` | `/dashboard/finance` | 1 |
| `tax/page.tsx` | `/dashboard/tax` | `/dashboard/finance?tab=tax` | `/dashboard/finance` | 1 |
| `bank-api/page.tsx` | `/dashboard/bank-api` | `/dashboard/finance?tab=bank-api` | `/dashboard/finance` | 0 |
| `expenses/page.tsx` | `/dashboard/expenses` | `/dashboard/hr?tab=expenses` | `/dashboard/finance`, `/dashboard/hr` | 2 |
| `recruitment/page.tsx` | `/dashboard/recruitment` | `/dashboard/hr?tab=recruitment` | `/dashboard/hr` | 2 |
| `ess/page.tsx` | `/dashboard/ess` | `/dashboard/hr?tab=ess` | `/dashboard/hr` | 1 |
| `appraisals/page.tsx` | `/dashboard/appraisals` | `/dashboard/hr?tab=appraisals` | `/dashboard/hr` | 2 |
| `training/page.tsx` | `/dashboard/training` | `/dashboard/hr?tab=training` | `/dashboard/hr` | 2 |
| `timesheets/page.tsx` | `/dashboard/timesheets` | `/dashboard/hr?tab=timesheets` | `/dashboard/hr` | 2 |
| `webhooks/page.tsx` | `/dashboard/webhooks` | `/dashboard/integrations?tab=webhooks` | `/dashboard/integrations` | 1 |
...
| `fleet/page.tsx` | `/dashboard/fleet` | `/dashboard/logistics?tab=fleet` | `/dashboard/logistics` | 1 |
...
| `tpm/page.tsx` | `/dashboard/tpm` | `/dashboard/marketing?tab=tpm` | `/dashboard/marketing` | 2 |
...
| `kanban/page.tsx` | `/dashboard/kanban` | `/dashboard/planning?tab=kanban` | `/dashboard/planning` | 2 |
| `procurement-suggestion/page.tsx` | `/dashboard/procurement-suggestion` | `/dashboard/procurement?tab=suggestions` | `/dashboard/procurement` | 1 |
| `subcontracting/page.tsx` | `/dashboard/subcontracting` | `/dashboard/procurement?tab=subcontracting` | `/dashboard/procurement` | 1 |
| `landed-cost/page.tsx` | `/dashboard/landed-cost` | `/dashboard/procurement?tab=landed-cost` | `/dashboard/procurement` | 2 |
...
| `qms/page.tsx` | `/dashboard/qms` | `/dashboard/quality?tab=qms` | `/dashboard/quality` | 2 |
...
| `contracts/page.tsx` | `/dashboard/contracts` | `/dashboard/sales?tab=contracts` | `/dashboard/sales` | 2 |
| `recurring-orders/page.tsx` | `/dashboard/recurring-orders` | `/dashboard/sales?tab=recurring` | `/dashboard/sales` | 3 |
| `commissions/page.tsx` | `/dashboard/commissions` | `/dashboard/sales?tab=commissions` | `/dashboard/sales` | 1 |
| `secondary-sales/page.tsx` | `/dashboard/secondary-sales` | `/dashboard/sales?tab=secondary` | `/dashboard/sales` | 1 |
| `van-sales/page.tsx` | `/dashboard/van-sales` | `/dashboard/sales?tab=van-sales` | `/dashboard/sales` | 2 |
| `portal/page.tsx` | `/dashboard/portal` | `/dashboard/sales?tab=portal` | `/dashboard/sales` | 3 |
...
| `esg/page.tsx` | `/dashboard/esg` | `/dashboard/utility-management?tab=esg` | `/dashboard/utility-management` | 1 |
...
|----------|-------|--------|
| RESTORE_OLD_PAGE_FROM_GIT | 54 | Restore from git commit `674b6c5` + add BYPASS_PREFIX_REDIRECT |
