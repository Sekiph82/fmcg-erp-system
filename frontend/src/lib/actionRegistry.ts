...
export const ACTION_REGISTRY: PaletteAction[] = [
  ...
  { id: "create_contract",          label: "New Contract",             description: "Create a new contract",             category: "action", icon: "📝", href: "/dashboard/sales?tab=contracts&drawer=create",       keywords: ["agreement"], permission: "sales.view" },
  { id: "create_expense_claim",     label: "New Expense Claim",        description: "Submit a new expense",              category: "action", icon: "💸", href: "/dashboard/hr?tab=expenses&drawer=create",            keywords: ["expense", "claim", "reimburse"], permission: "hr.view" },
  { id: "create_job_requisition",   label: "New Job Requisition",      description: "Open a new hiring request",         category: "action", icon: "👥", href: "/dashboard/hr?tab=recruitment",                       keywords: ["hire", "recruit", "job"], permission: "hr.view" },
  { id: "create_kanban_card",       label: "New Kanban Card",          description: "Create a new task card",            category: "action", icon: "🗂️", href: "/dashboard/planning?tab=kanban",                      keywords: ["task", "card"], permission: "hr.view" },
  { id: "create_van_trip",          label: "Start Van Route",          description: "Begin van sales route",             category: "action", icon: "🚐", href: "/dashboard/sales?tab=van-sales",                      keywords: ["van", "route", "mobile"], permission: "sales.view" },
  { id: "import_statement",         label: "Import Bank Statement",    description: "Import a bank statement CSV",       category: "action", icon: "🏦", href: "/dashboard/finance?tab=bank-recon",                   keywords: ["bank", "recon", "statement"], permission: "finance.view" },

  // ── Run actions ───────────────────────────────────────────────────────────

  { id: "run_mrp",            label: "Run MRP",                  description: "Execute Material Requirements Planning", category: "action", icon: "⚙️",  href: "/dashboard/planning?tab=mrp",              keywords: ["mrp", "planning", "materials"], permission: "production.view" },
  { id: "run_procurement_ai", label: "Run Procurement AI",       description: "Generate procurement suggestions",      category: "action", icon: "🤖",  href: "/dashboard/procurement?tab=suggestions",   keywords: ["ai", "suggest", "buy"], permission: "procurement.view" },
  { id: "run_bank_recon",     label: "Run Bank Reconciliation",  description: "Auto-match bank transactions",          category: "action", icon: "🔄",  href: "/dashboard/finance?tab=bank-recon",        keywords: ["bank", "match", "reconcile"], permission: "finance.view" },
  { id: "run_invoice_match",  label: "Run Invoice Matching",     description: "3-way PO/GRN/Invoice match",           category: "action", icon: "✅",  href: "/dashboard/finance?tab=invoice-match",     keywords: ["match", "invoice", "3way"], permission: "finance.view" },
  ...
  { id: "run_payroll",        label: "Run Kenya Payroll",        description: "Calculate payroll for this period",    category: "action", icon: "💰",  href: "/dashboard/hr?tab=payroll",                keywords: ["payroll", "salary", "kenya"], permission: "hr.view" },
  { id: "run_production_ai",  label: "Run Production AI Agents", description: "Analyze production performance",       category: "action", icon: "🏭",  href: "/dashboard/production?tab=plans",          keywords: ["production", "oee", "ai"], permission: "production.view" },
  ...
  { id: "report_dunning",        label: "Aging Report",          description: "Open accounts receivable aging",  category: "report", icon: "📊", href: "/dashboard/finance?tab=dunning",               keywords: ["aging", "ar", "overdue"], permission: "finance.view" },
  { id: "report_custom_builder", label: "Build Custom Report",   description: "Open Report Builder",             category: "report", icon: "🛠️", href: "/dashboard/analytics?tab=report-builder",     keywords: ["report", "custom", "build"], permission: "analytics.view" },
  { id: "report_esg",            label: "ESG Reports",           description: "Sustainability & emissions",       category: "report", icon: "🌱", href: "/dashboard/utility-management?tab=esg",        keywords: ["esg", "sustainability", "carbon"], permission: "hr.view" },
  ...
  { id: "ai_rider_performance",  label: "Rider Performance Analysis",  description: "AI field sales analysis",            category: "ai", icon: "🧠", href: "/dashboard/sales?tab=van-sales",                      keywords: ["rider", "van", "performance"] },
