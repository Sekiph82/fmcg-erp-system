...
export const NAV_CONFIG: NavEntry[] = [
  ...
  // ║    ESG / SUSTAINABILITY               ║
  // ╚══════════════════════════════════════╝
  cluster("cluster-esg", "ESG & Sustainability"),
  ...
  // ║         CYCLE COUNTING              ║
  // ╚══════════════════════════════════════╝
  cluster("cluster-cycle-count", "Inventory Accuracy"),

  {
    ...
    items: [
      { label: "Dashboard",       href: "/dashboard/cycle-count",              permission: "hr.view" },
      { label: "Count Plans",     href: "/dashboard/cycle-count/plans",        permission: "hr.view" },
      { label: "Count Tasks",     href: "/dashboard/cycle-count/tasks",        permission: "hr.view" },
      { label: "Count Entries",   href: "/dashboard/cycle-count/entries",      permission: "hr.view" },
      { label: "Variance Review", href: "/dashboard/cycle-count/variances",    permission: "hr.view" },
      { label: "Reports & AI",    href: "/dashboard/cycle-count/reports",      permission: "hr.view" },
    ],
  },
