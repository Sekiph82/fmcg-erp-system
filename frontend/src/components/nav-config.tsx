...
export const NAV_CONFIG: NavEntry[] = [
...

  {
    ...
    items: [
      ...
      { label: "eTIMS / e-Invoice", href: "/dashboard/finance/etims",            permission: "finance.view" },
      { label: "VAT Returns (VAT3)",href: "/dashboard/finance/vat-returns",      permission: "finance.view" },
    ],
  },
...

  {
    ...
    items: [
      { label: "Dashboard",          href: "/dashboard/report-builder",              permission: "analytics.view" },
      { label: "Executive KPIs",     href: "/dashboard/report-builder/executive",    permission: "analytics.view" },
      { label: "Data Catalog",       href: "/dashboard/report-builder/catalog",      permission: "analytics.view" },
      { label: "Build Report",       href: "/dashboard/report-builder/builder",      permission: "analytics.view" },
      { label: "Saved Reports",      href: "/dashboard/report-builder/saved",        permission: "analytics.view" },
      { label: "Report Viewer",      href: "/dashboard/report-builder/viewer",       permission: "analytics.view" },
      { label: "Dashboards",         href: "/dashboard/report-builder/dashboards",   permission: "analytics.view" },
      { label: "Schedules",          href: "/dashboard/report-builder/schedules",    permission: "analytics.view" },
      { label: "Row-Level Security", href: "/dashboard/report-builder/rls",          permission: "analytics.view" },
      { label: "AI Insights",        href: "/dashboard/report-builder/ai",           permission: "analytics.view" },
    ],
  },
