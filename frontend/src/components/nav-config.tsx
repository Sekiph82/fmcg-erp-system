/**
 * ERP Navigation Configuration — Domain-based hierarchy (14 clusters)
 * Data-driven. Add a section here — sidebar renders automatically.
 */
...
/** Non-interactive cluster label — visually separates domain groups */
...
export const NAV_CONFIG: NavEntry[] = [
  ...
  // 2. MASTER DATA
  // ══════════════════════════════════════════
  cluster("cluster-master-data", "Master Data"),

  {
    type: "section",
    id: "master",
    label: "Master Data",
    icon: md("M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4"),
    items: [
  ...
  // 3. PLANNING
  // ══════════════════════════════════════════
  cluster("cluster-planning", "Planning"),
...

  {
    ...
    permission: "production.view",
    icon: md("M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"),
    items: [
...

  {
    ...
    icon: md("M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18"),
    items: [
      { label: "Planning Dashboard",  href: "/dashboard/planning",                permission: "planning.view" },
      { label: "Schedule Board",      href: "/dashboard/planning/schedule",       permission: "planning.view" },
      { label: "Capacity Board",      href: "/dashboard/planning/capacity",       permission: "planning.view" },
      { label: "Bottleneck Explorer", href: "/dashboard/planning/bottlenecks",    permission: "planning.view" },
      { label: "Simulation Sandbox",  href: "/dashboard/planning/simulation",     permission: "planning.view" },
      { label: "Changeover Matrix",   href: "/dashboard/planning/changeover",     permission: "planning.view" },
    ],
  },
  ...
  // 4. PRODUCTION / MES
  // ══════════════════════════════════════════
  cluster("cluster-production", "Production / MES"),

  {
    ...
    permission: "production.view",
    icon: md("M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"),
    items: [
...

  {
    ...
    permission: "production.view",
    icon: md("M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"),
    items: [
...

  {
    ...
    permission: "production.view",
    icon: md("M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"),
    items: [
  ...
  // ══════════════════════════════════════════
  cluster("cluster-inventory", "Inventory & Warehouse"),
...

  {
    ...
    permission: "shelf_life.view",
    icon: md("M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"),
    items: [
      { label: "SL Dashboard",          href: "/dashboard/shelf-life",                      permission: "shelf_life.view" },
      { label: "FEFO Config",           href: "/dashboard/shelf-life/fefo-config",          permission: "shelf_life.view" },
      { label: "Lot Aging Explorer",    href: "/dashboard/shelf-life/lot-aging",            permission: "shelf_life.view" },
      { label: "Near-Expiry Board",     href: "/dashboard/shelf-life/near-expiry",          permission: "shelf_life.view" },
      { label: "Expired Stock Board",   href: "/dashboard/shelf-life/expired",              permission: "shelf_life.view" },
      { label: "Retest Queue",          href: "/dashboard/shelf-life/retest-queue",         permission: "shelf_life.approve" },
      { label: "Shipment Validation",   href: "/dashboard/shelf-life/shipment-validation",  permission: "shelf_life.view" },
      { label: "Production Validation", href: "/dashboard/shelf-life/production-validation",permission: "shelf_life.view" },
      { label: "FEFO Compliance Audit", href: "/dashboard/shelf-life/compliance",           permission: "shelf_life.report" },
      { label: "Disposition Console",   href: "/dashboard/shelf-life/disposition",          permission: "shelf_life.dispose" },
      { label: "Customer SL Rules",     href: "/dashboard/shelf-life/customer-rules",       permission: "shelf_life.edit" },
      { label: "Bulk Hold Monitor",     href: "/dashboard/shelf-life/bulk-hold-monitor",    permission: "shelf_life.hold" },
    ],
  },

  {
    ...
    permission: "production.view",
    icon: md("M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"),
    items: [
...

  {
    ...
    label: "Cycle Count",
    permission: "inventory.view",
    icon: md("M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"),
    items: [
      { label: "Dashboard",       href: "/dashboard/cycle-count",           permission: "inventory.view" },
      { label: "Count Plans",     href: "/dashboard/cycle-count/plans",     permission: "inventory.view" },
      { label: "Count Tasks",     href: "/dashboard/cycle-count/tasks",     permission: "inventory.view" },
      { label: "Count Entries",   href: "/dashboard/cycle-count/entries",   permission: "inventory.view" },
      { label: "Variance Review", href: "/dashboard/cycle-count/variances", permission: "inventory.view" },
      { label: "Reports & AI",    href: "/dashboard/cycle-count/reports",   permission: "inventory.view" },
    ],
  },
  ...
  // ══════════════════════════════════════════
  cluster("cluster-quality", "Quality & Compliance"),
...

  {
    ...
    items: [
      ...
      { label: "Instrument Calibration",href: "/dashboard/qms/calibration",       permission: "quality.view" },
      { label: "AQL Sampling Plans",   href: "/dashboard/qms/aql",               permission: "quality.view" },
      { label: "Certificate of Analysis",href: "/dashboard/qms/coa",             permission: "quality.view" },
      { label: "Audit Checklists",       href: "/dashboard/qms/audit-checklists",   permission: "quality.view" },
      { label: "Supplier Food Safety",  href: "/dashboard/qms/supplier-safety",    permission: "quality.view" },
...

  {
    ...
    permission: "quality.view",
    icon: md("M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"),
    items: [
      ...
      { label: "Cleaning Validation", href: "/dashboard/allergen/cleaning",          permission: "quality.view" },
...

  {
    ...
    permission: "gs1.view",
    icon: md("M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z"),
    items: [
      { label: "GS1 Dashboard",     href: "/dashboard/gs1",             permission: "gs1.view" },
      { label: "GS1 Configuration", href: "/dashboard/gs1/config",      permission: "gs1.view" },
      { label: "Barcode Generator", href: "/dashboard/gs1/barcodes",    permission: "gs1.view" },
      { label: "Label Templates",   href: "/dashboard/gs1/labels",      permission: "gs1.view" },
      { label: "Print Queue",       href: "/dashboard/gs1/print-queue", permission: "gs1.print" },
      { label: "SSCC Pallets",      href: "/dashboard/gs1/sscc",        permission: "gs1.view" },
      { label: "Scan Debug",        href: "/dashboard/gs1/scan",        permission: "gs1.view" },
      { label: "GS1 Reports",       href: "/dashboard/gs1/reports",     permission: "gs1.report" },
      { label: "AI Agents",         href: "/dashboard/gs1/ai",          permission: "gs1.admin" },
    ],
  },
  ...
  // ══════════════════════════════════════════
  cluster("cluster-procurement", "Procurement & Suppliers"),

  {
    ...
    label: "Procurement",
    permission: "procurement.view",
    icon: md("M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"),
    items: [
      ...
      { label: "RFQ",                  href: "/dashboard/procurement/rfq",                    permission: "procurement.view" },
      { label: "Blanket Agreements",   href: "/dashboard/procurement/blanket-agreements",     permission: "procurement.view" },
      { label: "Reorder Policies",     href: "/dashboard/procurement/reorder-policies",       permission: "procurement.view" },
...

  {
    ...
    permission: "procurement.view",
    icon: md("M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-2 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"),
    items: [
...

  {
    ...
    permission: "procurement.view",
    icon: md("M3 10h18M3 14h18M10 3v18M14 3v18M3 6a3 3 0 013-3h12a3 3 0 013 3v12a3 3 0 01-3 3H6a3 3 0 01-3-3V6z"),
    items: [
...

  {
    ...
    permission: "procurement.view",
    icon: md("M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"),
    items: [
...

  {
    ...
    items: [
      ...
      { label: "AI Pricing Engine",   href: "/dashboard/dynamic-pricing",            permission: "sales.view" },
...

  {
    ...
    permission: "sales.view",
    icon: md("M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"),
    items: [
...

  {
    ...
    permission: "sales.view",
    icon: md("M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"),
    items: [
...

  {
    ...
    permission: "sales.view",
    icon: md("M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"),
    items: [
...

  {
    ...
    permission: "sales.view",
    icon: md("M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"),
    items: [
...

  {
    ...
    items: [
      ...
      { label: "Order Tracking",    href: "/dashboard/portal/order-tracking",     permission: "sales.view" },
      { label: "Sell-Through Upload",href: "/dashboard/portal/sell-through",      permission: "sales.view" },
  ...
  // 9. MARKETING & CRM
  // ══════════════════════════════════════════
  cluster("cluster-marketing", "Marketing & CRM"),

  {
    ...
    label: "CRM Pipeline",
    permission: "sales.view",
    icon: md("M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"),
    items: [
...

  {
    ...
    icon: md("M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z", "M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"),
    items: [
  ...
  // ══════════════════════════════════════════
  cluster("cluster-finance", "Finance & Accounting"),

  {
    ...
    items: [
      ...
      { label: "Exchange Rates",  href: "/dashboard/finance/exchange-rates",    permission: "finance.view" },
...

  {
    type: "section",
    id: "accounting",
    label: "Ledgers & Accounting",
    permission: "finance.view",
    icon: md("M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"),
    items: [
      { label: "Dashboard",          href: "/dashboard/finance/accounting",                          permission: "finance.view" },
      { label: "Chart of Accounts",  href: "/dashboard/finance/accounting/chart-of-accounts",        permission: "finance.view" },
      { label: "Journal Entries",    href: "/dashboard/finance/accounting/journal",                  permission: "finance.view" },
      { label: "General Ledger",     href: "/dashboard/finance/accounting/general-ledger",           permission: "finance.view" },
      { label: "Trial Balance",      href: "/dashboard/finance/accounting/trial-balance",            permission: "finance.view" },
...

  {
    ...
    permission: "finance.view",
    icon: md("M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"),
    items: [
...

  {
    ...
    permission: "finance.view",
    icon: md("M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"),
    items: [
...

  {
    ...
    permission: "finance.view",
    icon: md("M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"),
    items: [
...

  {
    ...
    permission: "tax.view",
    icon: md("M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z"),
    items: [
      ...
      { label: "eTIMS / e-Invoice", href: "/dashboard/finance/etims",            permission: "tax.view" },
      { label: "VAT Returns (VAT3)",href: "/dashboard/finance/vat-returns",      permission: "tax.view" },
    ],
  },
...

  {
    ...
    permission: "hr.view",
    icon: md("M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"),
    items: [
      ...
      { label: "Kenya Payroll",    href: "/dashboard/payroll",          permission: "payroll_ke.view" },
      { label: "Payroll Profiles", href: "/dashboard/payroll/profiles", permission: "payroll_ke.view" },
      { label: "Payroll Reports",  href: "/dashboard/payroll/reports",  permission: "payroll_ke.view" },
...

  {
    ...
    permission: "hr.view",
    icon: md("M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z"),
    items: [
...

  {
    ...
    permission: "hr.view",
    icon: md("M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"),
    items: [
...

  {
    ...
    permission: "hr.view",
    icon: md("M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0112 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222"),
    items: [
...

  {
    ...
    permission: "hr.view",
    icon: md("M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"),
    items: [
...

  {
    ...
    permission: "hr.view",
    icon: md("M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"),
    items: [
  ...
  // ══════════════════════════════════════════
  // 12. LOGISTICS & FIELD OPERATIONS
  // ══════════════════════════════════════════
  cluster("cluster-logistics", "Logistics & Field Operations"),
...

  {
    ...
    permission: "logistics.view",
    icon: md("M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z", "M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2 1h2m0-11h8l2 4h2a1 1 0 011 1v4l-3 1"),
    items: [
      { label: "Dashboard",   href: "/dashboard/fleet",             permission: "logistics.view" },
      { label: "Vehicles",    href: "/dashboard/fleet/vehicles",    permission: "logistics.view" },
      { label: "Drivers",     href: "/dashboard/fleet/drivers",     permission: "logistics.view" },
      { label: "Trips",       href: "/dashboard/fleet/trips",       permission: "logistics.view" },
      { label: "Fuel Log",    href: "/dashboard/fleet/fuel",        permission: "logistics.view" },
      { label: "Maintenance", href: "/dashboard/fleet/maintenance", permission: "logistics.view" },
      { label: "Incidents",   href: "/dashboard/fleet/incidents",   permission: "logistics.view" },
      { label: "Reports & AI",href: "/dashboard/fleet/reports",     permission: "logistics.view" },
    ],
  },

  {
    ...
    permission: "sales.view",
    icon: md("M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"),
    items: [
...

  {
    ...
    items: [
      ...
      { label: "Predictive Maintenance", href: "/dashboard/maintenance/predictive", permission: "maintenance.view" },
  ...
  // ══════════════════════════════════════════
  // 13. UTILITIES & SUSTAINABILITY
  // ══════════════════════════════════════════
  cluster("cluster-utilities", "Utilities & Sustainability"),

  {
    ...
    icon: md("M13 10V3L4 14h7v7l9-11h-7z"),
    items: [
...

  {
    ...
    icon: md("M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"),
    items: [
      { label: "ESG Dashboard",       href: "/dashboard/esg",               permission: "esg.view" },
      { label: "Activity Data",       href: "/dashboard/esg/activities",    permission: "esg.view" },
      { label: "Emission Factors",    href: "/dashboard/esg/factors",       permission: "esg.view" },
      { label: "Carbon Per Product",  href: "/dashboard/esg/carbon",        permission: "esg.view" },
      { label: "ESG Intelligence",    href: "/dashboard/esg/intelligence",  permission: "esg.view" },
      { label: "ESG Targets",         href: "/dashboard/esg/targets",       permission: "esg.view" },
      { label: "ESG Reports",         href: "/dashboard/esg/reports",       permission: "esg.view" },
    ],
  },

  // ══════════════════════════════════════════
  // 14. SYSTEM, AI & PLATFORM
  // ══════════════════════════════════════════
  cluster("cluster-platform", "System, AI & Platform"),

  {
    ...
    items: [
      ...
      { label: "NL ERP Control",      href: "/dashboard/ai/nl-command",       permission: "ai.view" },
      { label: "AI Governance",       href: "/dashboard/ai/governance",        permission: "ai.view" },
...

  {
    ...
    icon: md("M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"),
    items: [
      { label: "Dashboard",          href: "/dashboard/report-builder",              permission: "reports.view" },
      { label: "Executive KPIs",     href: "/dashboard/report-builder/executive",    permission: "reports.view" },
      { label: "Data Catalog",       href: "/dashboard/report-builder/catalog",      permission: "reports.view" },
      { label: "Build Report",       href: "/dashboard/report-builder/builder",      permission: "reports.create" },
      { label: "Saved Reports",      href: "/dashboard/report-builder/saved",        permission: "reports.view" },
      { label: "Report Viewer",      href: "/dashboard/report-builder/viewer",       permission: "reports.view" },
      { label: "Dashboards",         href: "/dashboard/report-builder/dashboards",   permission: "reports.view" },
      { label: "Schedules",          href: "/dashboard/report-builder/schedules",    permission: "reports.create" },
      { label: "Row-Level Security", href: "/dashboard/report-builder/rls",          permission: "reports.admin" },
      { label: "AI Insights",        href: "/dashboard/report-builder/ai",           permission: "reports.view" },
    ],
  },
...

  {
    ...
    icon: md("M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"),
    items: [
      { label: "Dashboard",         href: "/dashboard/notification-center",            permission: "notifications.view" },
      { label: "All Notifications", href: "/dashboard/notification-center/list",       permission: "notifications.view" },
      { label: "Preferences",       href: "/dashboard/notification-center/preferences",permission: "notifications.manage" },
      { label: "Templates",         href: "/dashboard/notification-center/templates",  permission: "notifications.configure" },
      { label: "Schedules",         href: "/dashboard/notification-center/schedules",  permission: "notifications.configure" },
      { label: "Reports",           href: "/dashboard/notification-center/reports",    permission: "notifications.report" },
      { label: "AI Insights",       href: "/dashboard/notification-center/ai",         permission: "notifications.view" },
    ],
  },

  {
    ...
    items: [
      ...
      { label: "Shift Schedule", href: "/dashboard/calendar/shifts",      permission: "hr.view" },
...

  {
    ...
    label: "Custom Fields",
    permission: "hr.view",
    icon: md("M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"),
    items: [
      ...
      { label: "Form Builder",    href: "/dashboard/custom-fields/form-builder",       permission: "hr.view" },
      { label: "Workflow Rules",  href: "/dashboard/custom-fields/workflow-rules",     permission: "hr.view" },
...

  {
    ...
    items: [
      { label: "Dashboard",       href: "/dashboard/webhooks",             permission: "integrations.view" },
      { label: "Event Definitions",href: "/dashboard/webhooks/definitions",permission: "integrations.view" },
      { label: "Subscriptions",   href: "/dashboard/webhooks/subscriptions",permission: "integrations.view" },
      { label: "Deliveries",      href: "/dashboard/webhooks/deliveries",  permission: "integrations.view" },
      { label: "Dead Letter",     href: "/dashboard/webhooks/dead-letter", permission: "integrations.view" },
      { label: "Inbound",         href: "/dashboard/webhooks/inbound",     permission: "integrations.view" },
      { label: "Reports & AI",    href: "/dashboard/webhooks/reports",     permission: "integrations.view" },
    ],
  },

  {
    ...
    items: [
      ...
      { label: "Developer Portal",href: "/dashboard/developer",                  permission: "integrations.view" },
      { label: "API Keys",        href: "/dashboard/developer/keys",             permission: "integrations.view" },
      { label: "GraphQL Layer",   href: "/dashboard/developer/graphql",          permission: "integrations.view" },
    ],
  },

  {
    ...
    icon: md("M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z", "M15 12a3 3 0 11-6 0 3 3 0 016 0z"),
    items: [
      { label: "Approval Inbox",     href: "/dashboard/approvals",          permission: "finance.view" },
      { label: "Mobile Apps",        href: "/dashboard/mobile",             permission: "hr.view" },
      { label: "Mobile Approvals",   href: "/dashboard/mobile/approvals",   permission: "hr.view" },
      { label: "Device Manager",     href: "/dashboard/mobile/devices",     permission: "hr.view" },
      { label: "Companies",          href: "/dashboard/companies",          permission: "users.view" },
      ...
      { label: "Knowledge Base",      href: "/dashboard/knowledge-base",              permission: "knowledge_base.view" },
      { label: "KB Articles",         href: "/dashboard/knowledge-base/articles",     permission: "knowledge_base.view" },
      { label: "Documents",           href: "/dashboard/documents",                   permission: "documents.view" },
      { label: "Expiry Tracker",      href: "/dashboard/documents/expiring",          permission: "documents.view" },
      { label: "Compliance Docs",     href: "/dashboard/documents/compliance",        permission: "documents.view" },
      { label: "E-Signatures",        href: "/dashboard/esign",                       permission: "esign.view" },
      ...
      { label: "Compliance Trail",    href: "/dashboard/logs/compliance",         permission: "audit.view" },
      { label: "Retention Policies",  href: "/dashboard/logs/retention",          permission: "audit.view" },
    ],
  },

  {
    ...
    items: [
      ...
      { label: "UOM Conversions", href: "/dashboard/utilities/uom",        permission: "utilities.view" },
      { label: "Number Series",   href: "/dashboard/utilities/series",     permission: "utilities.view" },
      { label: "Currencies",      href: "/dashboard/utilities/currencies", permission: "utilities.view" },
    ],
  },
