      ...
      {adoption && (
        <div className="bg-white rounded-xl border shadow-sm p-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-blue-700">{adoption.activation_rate_pct as number}%</span>
          </div>
          <div className="flex justify-between text-xs text-gray-400 mt-1">
            <span>{adoption.active_accounts as number} active</span>
            <span>{adoption.total_accounts as number} total</span>
          </div>
        </div>
      )}
